...
Unittest classes:
    ...
    TestSqaure_x
    TestSquare_y
    TestSqaure_initialization_order
    TestSquare_area
    TestSqaure_stdout
    TestSquare_args_update
    TestSquare_kwargs_update
...
class TestSquare_instantiation(unittest.TestCase):
    """unittests for testing instantiation of class Square"""
    ...
    def test_four_args(self):
        self.assertEqual(1, Square(10, 2, 2, 1).id)
