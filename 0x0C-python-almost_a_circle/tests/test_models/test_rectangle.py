...
Unittest classes:
    ...
    TestRectangle_area
    TestRectangle_args_update
    TestRectangle_kwargs_update
...
class TestRectangle_args_update(unittest.TestCase):
...
class TestRectangle_kwargs_update(unittest.TestCase):
